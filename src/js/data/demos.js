export const demos = {
    alpinejs: {
        image: {
            src: "/img/alpine.png",
            alt: "Alpine.js Personal Simple Demo ThumbnailONE JPCS Student Portal Thumbnail"
        },
        content: {
            title: "Alpine.js",
            description: `A very basic demonstration of how alpine.js directives works.`,
            badges: {
                HTML5: true,
                CSS3: true,
                JavaScript: true,
        ...
        links: {
            demo: {
                link: "https://danraposas.github.io/alpine-js/",
                target: "_blank",
                content: `
                    Demo

                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                        class="size-4 stroke-2 stroke-chicago-100">
            ...
            repository: {
                link: "https://github.com/DanRaposas/alpine-js",
                target: "_blank",
                content: `
                    Source

                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 -2 24 24" class="size-4 fill-chicago-100">
                        <path
